...
/**
 *	\file       myo2xpmodule/myo2xpmoduleindex.php
 *	\ingroup    myo2xpmodule
 *	\brief      Home page of myo2xpmodule top menu
 */
...
$langs->loadLangs(array("myo2xpmodule@myo2xpmodule"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->myo2xpmodule->read) accessforbidden();
...
llxHeader("", $langs->trans("MyO2XPModuleArea"));

print load_fiche_titre($langs->trans("MyO2XPModuleArea"), '', 'myo2xpmodule.png@myo2xpmodule');
...
// Draft MyObject
if (! empty($conf->myo2xpmodule->enabled) && $user->rights->myo2xpmodule->read)
{
	$langs->load("orders");
