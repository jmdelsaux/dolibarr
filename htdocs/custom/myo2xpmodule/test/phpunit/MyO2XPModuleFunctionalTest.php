...
/**
 * \file    test/functional/MyO2XPModuleFunctionalTest.php
...
/**
 * Class MyO2XPModuleFunctionalTest
 *
 ...
 *
 * @package Testmyo2xpmodule
 */
class MyO2XPModuleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMyO2XPModule')->click();
		} else {
			// Disable the module
			$this->byHref('modMyO2XPModule')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/myo2xpmodule/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('myo2xpmodule/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/myo2xpmodule/admin/about.php');
		$this->authenticate();
		return $this->assertContains('myo2xpmodule/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('myo2xpmodulewidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modMyO2XPModule_MyO2XPModuleTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMyO2XPModule_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
