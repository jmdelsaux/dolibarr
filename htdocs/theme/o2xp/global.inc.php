...
@media only screen and (min-width: <?php echo empty($conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC3) ? round($nbtopmenuentries * 47, 0) + 40 : $conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC3; ?>px)
{
	.width25  { width: 25px; }
    .width50  { width: 50px; }
    .width75  { width: 75px; }
...
@media only screen and (max-width: <?php echo empty($conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC3) ? round($nbtopmenuentries * 47, 0) + 40 : $conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC3; ?>px)	/* reduction 3 */
{
...
@media only screen and (max-width: <?php echo empty($conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC1) ? round($nbtopmenuentries * 90, 0) + 240 : $conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC1; ?>px)	/* reduction 1 */
{
	div.tmenucenter {
...
@media only screen and (max-width: <?php echo empty($conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC2) ? round($nbtopmenuentries * 69, 0) + 40 : $conf->global->THEME_O2XP_WITDHOFFSET_FOR_REDUC2; ?>px)	/* reduction 2 */
{
	li.tmenucompanylogo {
		display: none;
	}
